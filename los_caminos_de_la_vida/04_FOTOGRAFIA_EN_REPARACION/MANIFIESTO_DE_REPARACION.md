# 04_FOTOGRAFIA_EN_REPARACION — LO QUE NO PASA AÚN (gestión del Director)
**Sistema de dos carpetas (orden del Jefe):**
- **`03_FOTOGRAFIA_FINAL/SECUENCIA_XX/`** = lo APROBADO, listo para animar, escena por escena.
- **`04_FOTOGRAFIA_EN_REPARACION/`** (esta carpeta) = lo que falla algo. Cuando el fotógrafo lo corrige y el Director lo aprueba, la foto SE MUEVE a FOTOGRAFIA_FINAL y sale de aquí.
